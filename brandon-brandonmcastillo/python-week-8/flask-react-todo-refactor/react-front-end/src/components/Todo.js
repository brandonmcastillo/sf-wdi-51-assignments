		...
		return (
			<li data-todos-index={this.props.todo.id}>
				<div style={this.state.bodyStyle}>
					<input type="checkbox" checked={Boolean(this.state.completed)} onChange={this.handleCheck} />
					<span className={this.state.completed ? 'completed item' : 'item'}>{this.props.todo.body}</span>
